...
function CheckinBooking() {
  ...
  const { isCheckingIn, checkingIn } = useCheckin();
  ...
  const totalToConfirm = addBreakfast
    ? `${formatCurrency(
  ...
  function handleCheckin() {
    if (addBreakfast)
      checkingIn({
        ...
        breakfast: {
          hasBreakfast: true,
          extrasPrice: additionalBreakfastPrice,
          totalPrice: totalPrice + additionalBreakfastPrice,
        },
      });
    else checkingIn({ bookingId, breakfast: {} });
  }
